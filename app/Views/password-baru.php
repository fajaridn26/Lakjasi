...
<head>
    ...
    <title>Password Baru - Lakjasi</title>
...
<body>
                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="pt-4 pb-2">
                                        <h5 class="card-title text-center pb-0 fs-4">Password Baru</h5>
                                    ...
                                    <?php endif; ?>
                                    <form method="post" action="<?= base_url('AuthenticationController/reset'); ?>" class="row g-3 needs-validation" novalidate>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="input-group has-validation">
                                                ...
                                                <span class="input-group-text" id="inputGroupPrepend"><i class="fa-solid fa-eye" style="color: #5A5A5A;" aria-hidden="true" id="eye2" onclick="toogle2()"></i></span>
                                                <div class="invalid-feedback">Masukkan password anda!</div>
                                            </div>
                                        </div>
                                        <div class="col-12">
    ...
    <script>
        ...
        function toogle2() {
            if (state) {
                document.getElementById("yourPassword2").setAttribute("type", "password");
                document.getElementById("eye2").style.color = '#5A5A5A';
                state = false;
            } else {
                document.getElementById("yourPassword2").setAttribute("type", "text");
