...
<head>
  ...
  <link rel="stylesheet" href="<?= base_url('leaflet-locate/L.Control.Locate.min.js')?>"
    integrity="sha256-kLaT2GOSpHechhsozzB+flnD+zUyjE2LlfWPgU04xyI=" crossorigin="" />
  <script src="<?= base_url('leaflet/leaflet.js')?>" integrity="sha256-WBkoXOwTeyKclOHuWtc+i2uENFpDZ9YPdf5Hf+D7ewM="
    crossorigin=""></script>
  <link rel="stylesheet"
        ...
        <?php foreach ($pelaporan as $key => $value) : ?>
          <div class="card">
            <div class="card-body">
              ...
              <script>
                var map = L.map('map').setView([<?=$value['lat']?> , <?=$value['long']?>], 11);
